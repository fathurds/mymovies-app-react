...
function Search() {
    ...
    return (
        <div className="container-fluid">
            ...
            <div className="justify-content-around align-items-center flex-wrap gap-3 mt-3 search-not-found list-dekstop">
            ...
            {/* MOBILE */}
            <div className="justify-content-around align-items-center flex-wrap gap-3 mt-3 search-not-found list-mobile">
                {listFilteredMovies.length === 0 && (<h2>Search Not Found</h2>)}
                {listFilteredMovies.map((el, i) => (
                    <Card className="border-secondary movie" style={{ width: '11rem' }} key={i} onClick={() => {
                        dispatch(setDetail(el.title));
                        navigate('/detail/' + el.id);
                    }} >
                        <Card.Img variant="top" src={"https://image.tmdb.org/t/p/w500" + el.poster_path} />
