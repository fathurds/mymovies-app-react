...
function Favorites() {
    ...
    return (
        <div>
            <div className="justify-content-around align-items-center flex-wrap py-5 search-not-found list-dekstop">
            ...
            <div className="justify-content-around align-items-center flex-wrap py-5 search-not-found list-mobile">
                {listFavorites.map((el, i) => (
                    <Card className="border-secondary movie-favorites" style={{ width: '11rem' }} key={i}>
                        <Card.Img variant="top" src={"https://image.tmdb.org/t/p/w500" + el.poster_path} onClick={() => {
                            navigate('/detail/' + el.id);
                        }} />
                        <Card.Body className="card-body-color">
